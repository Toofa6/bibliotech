...
public final class Main {
    ...
    private static void iniciarSesion(final Sistema sistema) {
        ...
        Socio usuario = new Socio(null, null, null, numeroSocio, contrasenia)
    ...
    private static void cambiarContrasenia(Sistema sistema) {
        ...
        String contraseniaActual = StdIn.readLine();
        StdOut.println("Ingrese su contraseña nueva: ");
        String contraseniaNueva = StdIn.readLine();

        sistema.cambiarContraseña(usuario, contraseniaNueva);
        StdOut.println("Contraseña actualizada. ");
